...
{
    public:
    SteinerParam(std::string input, std::string output) : inputFilepath(input), outputFilepath(output) {}
...
TEST_P(SteinerTest, Test)
{
    ...
    solutionData.close();
    std::vector< std::pair< std::pair<size_t, size_t>, double > > steiner_forest_edges; //TODO this type looks awful
...
INSTANTIATE_TEST_CASE_P(SteinerTree, SteinerTest,
                        ::testing::Values(SteinerParam(std::string(TESTS_DIR "forest_tests/vazirani0.in"),
...
INSTANTIATE_TEST_CASE_P(SteinerTree2, SteinerTest,
                        ::testing::Values(SteinerParam(std::string(TESTS_DIR "tree_tests/d01.in"),
...
INSTANTIATE_TEST_CASE_P(SteinerTree3, SteinerTest,
                        ::testing::Values(SteinerParam(std::string(TESTS_DIR "tree_tests/alue2087.in"),
...
INSTANTIATE_TEST_CASE_P(SteinerTree4, SteinerTest,
                        ::testing::Values(SteinerParam(std::string(TESTS_DIR "tree_tests/diw0234.in"),
...
INSTANTIATE_TEST_CASE_P(SteinerTree5, SteinerTest,
                        ::testing::Values(SteinerParam(std::string(TESTS_DIR "tree_tests/dmxa0296.in"),
...
INSTANTIATE_TEST_CASE_P(SteinerTree6, SteinerTest,
                        ::testing::Values(SteinerParam(std::string(TESTS_DIR "tree_tests/msm0580.in"),
...
INSTANTIATE_TEST_CASE_P(SteinerTree7, SteinerTest,
                        ::testing::Values(SteinerParam(std::string(TESTS_DIR "tree_tests/taq0014.in"),
...
INSTANTIATE_TEST_CASE_P(SteinerTree8, SteinerTest,
                        ::testing::Values(SteinerParam(std::string(TESTS_DIR "tree_tests/es20fst01.in"),
...
INSTANTIATE_TEST_CASE_P(SteinerTree9, SteinerTest,
                        ::testing::Values(SteinerParam(std::string(TESTS_DIR "tree_tests/es50fst01.in"),
...
INSTANTIATE_TEST_CASE_P(SteinerTree10, SteinerTest,
                        ::testing::Values(SteinerParam(std::string(TESTS_DIR "tree_tests/es80fst01.in"),
...
INSTANTIATE_TEST_CASE_P(SteinerTree11, SteinerTest,
                        ::testing::Values(SteinerParam(std::string(TESTS_DIR "tree_tests/es250fst01.in"),
...
INSTANTIATE_TEST_CASE_P(SteinerTree12, SteinerTest,
                        ::testing::Values(SteinerParam(std::string(TESTS_DIR "forest_tests/lp_small_test1.in"),
...
INSTANTIATE_TEST_CASE_P(SteinerForest, SteinerTest,
                        ::testing::Values(SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test1.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test1.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test2.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test2.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test3.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test3.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test4.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test4.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test5.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test5.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test6.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test6.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test7.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test7.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test8.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test8.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test9.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test9.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test10.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test10.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test11.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test11.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test12.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test12.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test13.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test13.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test14.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test14.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test15.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test15.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test16.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test16.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test17.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test17.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test18.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test18.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test19.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test19.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test20.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test20.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test21.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test21.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test22.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test22.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test23.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test23.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test24.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test24.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test25.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test25.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test26.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test26.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test27.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test27.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test28.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test28.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test29.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test29.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test30.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test30.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test31.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test31.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test32.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test32.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test33.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test33.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test34.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test34.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test35.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test35.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test36.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test36.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test37.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test37.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test38.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test38.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test39.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test39.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test40.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test40.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test41.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test41.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test42.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test42.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test43.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test43.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test44.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test44.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test45.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test45.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test46.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test46.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test47.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test47.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test48.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test48.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test49.in"),
                                                       std::string(TESTS_DIR "forest_tests/lp_very_small_test49.out")),
                                          SteinerParam(std::string(TESTS_DIR "forest_tests/lp_very_small_test50.in"),
...
INSTANTIATE_TEST_CASE_P(SteinerForest2, SteinerTest,
                        ::testing::Values(SteinerParam(std::string(TESTS_DIR "forest_tests/lp_4groups_test1.in"),
...
INSTANTIATE_TEST_CASE_P(SteinerForest3, SteinerTest,
                        ::testing::Values(SteinerParam(std::string(TESTS_DIR "forest_tests/lp_3groups_test1.in"),
