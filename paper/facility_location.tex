...
Columns are titled by $<samples\_multiplayer>$. \\
Number of iterations at each node of tree is $<samples\_multiplayer> \cdot <number_of_left_decisions>$.
From this it clearly follows that running time is proportional to the $<samples\_multiplayer>$.
...
As we can see raising $samples\_multiplayer$ doesn't affect answer significantly on the other hand
it increases running time dramatically.
