...
In this paper, terms listed below, should be interpreted in the following way:
\begin{itemize}
...
\item Design Pattern\footnote{\url{http://en.wikipedia.org/wiki/Software_design_pattern}}
	-- in our case, it is a weaker requirement than concept: design pattern has no interface,
	it is just a general guidance about responibilities and expected behavior of the class
	fulfilling it.
\end{itemize}
