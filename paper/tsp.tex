...
compared policies described in the previous sections on small instances from
...
we look for a subtree with a pretty low fitness of reachable solutions in hope
