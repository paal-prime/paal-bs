...
instances available in TSPLIB collection, \verb+eil*+ graphs with less than
$102$ instances. The most efficient MCTS algorithm (see next section for model
selection methodology) needed at least $2 s$ to find a solution which was
$1.1$-approximation, while local search algorithms were able to find a
$1.0001$-approximation within fraction of this time. Running the MCTS method
for medium-sized instances is impractical, for graphs with more than $10000$
vertices it is impossible.
