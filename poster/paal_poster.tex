  ...
  \begin{columns}		
    \begin{column}{.96\textwidth}
      ...
      \begin{block}{Metrical Uncapacitated Facility Location}
        Niech $G$ będzie grafem dwudzielnym o zbiorze wierzchołków $F \cup C$,
        gdzie $F$ jest zbiorem obiektów, a $C$ zbiorem miast. Niech $f_i$
        będzie kosztem otwarcia obiektu $i$, a $c_{ij}$ kosztem połaczenia
        miasta $j$ z (otwartym) obiektem $i$. Koszty połączeń spełniają
        nierówność trójkąta. Należy znaleźć podzbiór $I \subseteq F$ obiektów,
        które zostaną otwarte, oraz funkcję $\phi : C \rightarrow I$, która
        każdemu miastu będzie przypisywała obiekt otwarty. Łączny koszt
        otwarcia obiektów i połączenia miast z obiektami powinien być jak
        najmniejszy.
      \end{block}
